...
- **[Build A: 6-Fan Array](#build-a-6-fan-array)** — one knob drives 1–6 fans, wall-powered. Cheapest per fan once you go past 2.
- **[Build B: Independent per-fan control](#build-b-independent-per-fan-control)** — one controller per fan, USB-C powered, one knob per fan. Best for a single desk fan or for zoning.
...
### Fan: Thermalright TL-C14 (140 mm)

<img src="images/fan-tl-c14.jpg" width="160" alt="Thermalright TL-C14">

140 mm, 4-pin PWM, 1500 RPM, S-FDB bearing. Black/white; `-S` suffix adds ARGB. ฿222 (~\$6.73) for a single fan on [Shopee](https://shopee.co.th/product/1257844740/41804012010); cheaper in packs.

#### Pack discounts

The listing sells 1-, 3-, and 5-packs. Unit price drops with bigger packs:
...
#### Alternative: Arctic P12 Pro PST (120 mm)

<img src="images/fan-p12.webp" width="160" alt="Arctic P12 Pro PST">

120 mm option for tighter spaces — same 4-pin PWM, same stand. Wider RPM range (~200–2000 vs TL-C14's 1500 RPM max), and Arctic's PST (Pulse Sharing Technology) lets one fan's PWM signal drive a daisy-chained neighbour. 0.33 A per fan, black or white. ฿377 (~\$11.40) each on [Shopee](https://shopee.co.th/product/43263481/43358839984).

Swapping shifts the wattage but stays under either build's adapter limit (6 × P12 Pro = 24 W).

### Swivel case fan stand: YUJINX

<img src="images/stand.webp" width="160" alt="YUJINX swivel case fan stand">

360° tilt, fits 120/140 mm. Black or white. ฿238 (~\$7.20) on [Shopee](https://shopee.co.th/product/1120602245/56458012260) · cheaper at ~฿216 (~\$6.54) on [AliExpress](https://th.aliexpress.com/item/1005011662278182.html) when shipping to Thailand.
...
|-----:|-----------|----------------------:|------------:|----------------------:|------------:|
| 1 | 1×1-pack | ฿772 | ~\$23 | ฿534 | ~\$16 |
| 2 | 2×1-pack | ฿1,232 | ~\$37 | ฿756 | ~\$23 |
| 3 | 1×3-pack | ฿1,611 | ~\$49 | ฿897 | ~\$27 |
| 4 | 1×3 + 1×1 | ฿2,071 | ~\$63 | ฿1,119 | ~\$34 |
| 5 | 1×5-pack | ฿2,396 | ~\$73 | ฿1,206 | ~\$37 |
| 6 | 1×5 + 1×1 | ฿2,856 | ~\$87 | ฿1,428 | ~\$43 |
...
- **One knob = all fans.** No per-fan zones — for that, see [Build B](#build-b-independent-per-fan-control).
...
## Build B: Independent per-fan control
